...
if(isset($_GET['cat'])){
    echo '<script> var CategoryId =' . trim($_GET['cat']) . '</script>';
}else{
    echo "<script>var CategoryId;</script>";
}
?>
<!DOCTYPE html>
<html>
...
<section class="tv-shows padding-big" style="padding: 50px;">
    ...
    <div class="container">
        ...
        <div class="card-columns4" style="margin-top: 30px;" id="catPosts">
...
<script src="js/catcontents.js"></script>
