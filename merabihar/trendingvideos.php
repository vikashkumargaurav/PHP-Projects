...
<head>
    ...
    <title>MeraBihar :Trendings</title>
...
<section class="tv-shows padding-big" style="padding: 50px;">
    ...
    <div class="container">
        <!--        <div class="row">-->
        <!--            <div class="col-12" id="categoryDiv">-->
        <!---->
        <!--            </div>-->
        <!--        </div>-->
        <h2 style="font-weight: 300"><span >Trendings Videos</span></h2>

        <div class="card-columns" style="margin-top: 30px;" id="catPosts">
...
<script src="js/trendingvideos.js"></script>
