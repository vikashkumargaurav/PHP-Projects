...
$(document).ready(function () {
    makeAjax(API_IRL + 'ProfileInterestMappings/GetContentByProfileId/'+aid, 'GET', GetContentByProfileIdProfileInterestMappings);
})
function GetContentByProfileIdProfileInterestMappings(data) {
