$(document).ready(function () {
    makeAjax(API_IRL + 'Contents/GetContentByInterestId/'+InterestId, 'GET', GetContentByInterestId);
    makeAjax(API_IRL + 'interest/'+InterestId, 'GET', GetinterestByInterestId);
})

function GetinterestByInterestId(data) {
    console.log(data);
    $('#Interest').html('#'+data.InterestName);
}
function GetContentByInterestId(data) {
    ...
    $('#trendingPosts').append(CategoriesRow);
}