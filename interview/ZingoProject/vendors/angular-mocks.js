 ...
 *
 * ```js
 *   $httpBackend.expect('GET', /\/userObj\/(.+)/, undefined, undefined, ['id'])
 *     .respond(function(method, url, data, headers, params) {
 *       // for requested url of '/userObj/1234' params is {id: '1234'}
 *     });
 *
 *   $httpBackend.whenPATCH(/\/userObj\/(.+)\/article\/(.+)/, undefined, undefined, ['userObj', 'article'])
 *     .respond(function(method, url, data, headers, params) {
 *       // for url of '/userObj/1234/article/567' params is {userObj: '1234', article: '567'}
 *     });
 * ```
 *
