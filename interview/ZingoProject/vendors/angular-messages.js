 ...
 * ```
 * The `required` message will be displayed to the userObj since it appears before the `email` message in the DOM.
 * Once the userObj types a single character, the `required` message will disappear (since the field now has a value)
