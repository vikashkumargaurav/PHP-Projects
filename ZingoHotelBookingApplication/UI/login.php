...
<div class="container" style="margin-top: 10%;">
    <div class="card card-login mx-auto mt-5">
        ...
        <div class="card-body">
            ...
            <!--                        </div>-->
            <!--                    </div>-->
            <button class="btn btn-primary btn-block" style=" border: none; background-image: linear-gradient(to right , #e9586b, #FF0000,  #FF0000 );border-radius: 25px " id="loginbtn">Login</button>
            <!--          </form>-->
