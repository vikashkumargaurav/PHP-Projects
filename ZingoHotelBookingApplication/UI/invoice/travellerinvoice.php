...
//        $this->Cell(180, 0, "", '', 0, 'L', false);
        ...
        $this->Ln(10);
        $this->Cell(100, 10, $val->BookingObj->RoomCategory.' ('.$val->BookingObj->NoOfAdults.' Adults , '.$val->BookingObj->NoOfChild.' Child)', 'LTR', 0, 'L', false);
        $this->Cell(40, 10, "Rooms ".$val->BookingObj->NoOfRooms.',Nights '.$val->BookingObj->DurationOfStay, 'LTR', 0, 'C', false);
        $this->Cell(40, 10, "Rs ".($val->BookingObj->SellRate)*($val->BookingObj->NoOfRooms), 'LTR', 0, 'C', false);

        $this->Ln(10);
        $this->Cell(100, 10, " GST Charges @ ".$val->BookingObj->GST.'%', 'LR', 0, 'L', false);
        $this->Cell(40, 10, "", 'LR', 0, 'C', false);
        $this->Cell(40, 10, "Rs ".$val->BookingObj->GSTAmount, 'LR', 0, 'C', false);
        $this->SetFont('Times', '', 13);
        $this->Ln(10);
        $this->Cell(100, 10, " CGST @ ".(($val->BookingObj->GST)/2).'%', 'LR', 0, 'L', false);
        $this->Cell(40, 10, "", 'LR', 0, 'C', false);
        $this->Cell(40, 10, "", 'LR', 0, 'C', false);

        $this->Ln(10);
        $this->Cell(100, 10, " SGST @ ".(($val->BookingObj->GST)/2).'%', 'LR', 0, 'L', false);
        $this->Cell(40, 10, "", 'LR', 0, 'C', false);
        $this->Cell(40, 10, "", 'LR', 0, 'C', false);
...
//        $this->Cell(40, 10, "", 'LR', 0, 'C', false);
      if(sizeof($val->BookingObj->servicesList) != 0){
          ...
          $this->SetFont('Times', '', 13);
          /*for($i =1 ;$i <sizeof($val->BookingObj->servicesList);$i++){
              $this->Ln(10);
        ...
        $this->Cell(40, 10, "Rs.".$val->HotelObj->SummeryTotalAmount, 'TLRB', 0, 'C', false);

        $this->Ln(10);
        $this->Cell(100, 10, "", '', 0, 'L', false);
        $this->Cell(40, 10, "Amount Paid", 'LRB', 0, 'C', false);
        $this->Cell(40, 10, "Rs. ".$val->HotelObj->SummeryTotalPaidAmount, 'LRB', 0, 'C', false);

        $this->Ln(10);
        $this->Cell(100, 10, "", '', 0, 'L', false);
        $this->Cell(40, 10, "Balance Due", 'LRB', 0, 'C', false);
        $this->Cell(40, 10, "Rs. ".$val->HotelObj->SummeryRemainingAmount, 'LRB', 0, 'C', false);
