...
<ol class="breadcrumb">
    ...
    <li  style="font-weight: 700" class="breadcrumb-item active"><span id="HotelName"></span> All Bookings Statistics </li>
</ol>
        ...
        <div class="table-responsive">
            ...
            <table class="table table-bordered table-hover" id="bookingTable" width="100%" cellspacing="0">
                ...
                <tr>
                    ...
                    <th></th>
                    <th></th>
                    <th id="totalRoomNightFooter"></th>
                    <th id="RoomChargeFooter"></th>
                    <th id="ExtraChargeFooter"></th>
                    <th id="HotelTaxFooter"></th>
                    <th id="GrossChargesFooter"></th>
                    <th id="CommissionChargesFooter"></th>
                    <th id="CommissionGSTChargesFooter"></th>
                    <th id="CommissionIncludingGSTFooter"></th>
                    <th id="NettAmountFooter"></th>
                    <th></th>
                    <th id="CustomerPaidatHotelFooter"></th>
                    <th id="OTAToPayHotelFooter"></th>
                    <th id="HoteltoPayOTAFooter"></th>
                    <th></th>
                    <th></th>
                    <th></th>
                </tr>
...
<script src="js/pages/bookinglists.js"></script>
