            ...
            <div class="card card-register mx-auto mt-5">
                ...
                <div class="card-body">
                    <form>
                        ...
                        <a class="btn btn-primary btn-block" style=" border: none; background-image: linear-gradient(to right , #e9586b, #FF0000,  #FF0000 );border-radius: 25px " href="login.php">Register</a>
                    </form>
