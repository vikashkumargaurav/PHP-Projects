...
//        console.log(data);
        ...
        if(getHotelObj()){
            $('#hotelNameFront').append(getHotelObj().HotelName);
            $("#hotelNameFront").slideDown("slow");
            $('#hnftitle').slideDown("slow");
        }else {
            $('#hotelNameFront').append(data[0].HotelName);
            $("#hotelNameFront").slideDown("slow");
            $('#hnftitle').slideDown("slow");
        }
    }
