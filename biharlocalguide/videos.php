...
<head>
    ...
    <title>Top Popular Videos of Bihar Tourism </title>
    <link rel="icon" href="img/favlogo.png" type="image/png" sizes="16x16">
    <link rel="canonical" href="http://www.bihartourism.org/videos.php"/>
...
<section style="padding:20px 0;margin-top: 30px;">
    <div class="container">
        <div class="row">
            <div class="col">
                <h3>Videos</h3>
        ...
        <div class="card-columns" id="catPosts" style="margin-top: 40px;">
