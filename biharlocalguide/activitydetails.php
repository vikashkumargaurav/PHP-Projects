...
if (isset($_GET['activityId'])) {
    echo '<script> var activityId =' . trim($_GET['activityId']) . '</script>';
}else{
    echo "<script>var activityId;</script>";
}
if (!isset($_SESSION))
    session_start();
...
<head>
    ...
    <title>Top Popular Activities of Bihar Tourism </title>
    <link rel="icon" href="img/favlogo.png" type="image/png" sizes="16x16">
    <link rel="canonical" href="http://www.bihartourism.org/activitydetails.php"/>
...
<div class="container">
    ...
    <div class="row">
        ...
        <main class="post blog-post col-lg-8">
            <div class="container">
                <div class="post-single"  id="ActivityDiv">
        ...
        <aside class="col-lg-4">
            <div class="alert alert-light" role="alert" style="font-weight: 700">
                <span id="catNameNav"></span>Activity / <span>Page</span>
            </div>
            <div class="widget categories" id="InitialPackageDiv">
                <header>
                    <h3 class="h6">Book Your Package</h3>
                    <hr>

                </header>
                <div class="">
                    <h4 style="font-weight: 700;" id="initialPackageName"></h4>
                    <span style="font-weight: 600;font-size: 35px;" id="initialSellRate"></span> <span
                            style="font-weight: 500;color:darkgrey; text-decoration: line-through;"
                            id="initialDeclaredRate"></span><br>
                    <p><span style="font-weight: 600;color: darkgrey" id="Discount"></span></p>
                </div>

            </div>
            <div class="widget latest-posts" id="PackagesDiv">
                <header>
                    <h3 class="h6">Book Package</h3>
                </header>
                <div class="blog-posts" id="packageDiv">
        ...
        <div class="mapouter">
            <div class="gmap_canvas">
                <iframe width="100%" height="500" id="gmap_canvas"
                        src="https://maps.google.com/maps?q=patna%2Cbihar&t=&z=11&ie=UTF8&iwloc=&output=embed"
...
<script src="js/pages/activitydetails.js"></script>
<?php
