...
<head>
    ...
    <title>Top Popular Bloggers  Blogs of Bihar Tourism </title>
...
<section style="padding:50px 0;">
    <div class="container">
        <header>
            <h1 class="h2">Blogs  </h1><br>
            <h4 class="text-center" id="No" style="margin-top: 100px;display: none"></h4>
        </header>
...
<section style="padding:50px 0;">
    <div class="container">
        <header>
            <h1 class="h2">Recent Blogs</h1><br>
        </header>

        <div class="card-columns" id="recentBlogDIv">
...
<script src="js/pages/userblogs.js"></script>
