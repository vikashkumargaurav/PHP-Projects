<?php
if (isset($_GET['catId'])) {
    echo '<script> var catId =' . trim($_GET['catId']) . '</script>';
}else{
    echo "<script>var catId;</script>";
}
if (!isset($_SESSION))
    session_start();
...
<head>
    ...
    <title>Most Popular in Bihar for Tourism </title>
    <link rel="icon" href="img/favlogo.png" type="image/png" sizes="16x16">
    <link rel="canonical" href="http://www.bihartourism.org/catdetails.php"/>
...
<!--<div class="row" style="margin-top: 60px;">-->
    <div class="container" style="margin-top: 50px;">
        <h2 style="font-weight: 400" id="catNameNav"></h2><br>
        <p id="Description"></p>
    </div>
<!--</div>-->
...
<section >
    <div class="container" >
        <header>
            <h2 id="catNameOnNav" style="font-weight: 400"> </h2><br>
...
<hr>
<section style="padding: 46px 0;" class="latest-posts" id="activity-section">
    <div class="container">
        <header>
...
<script src="js/pages/catdetails.js"></script>
