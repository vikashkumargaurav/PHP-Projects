...
<head>
    ...
    <title>Top Popular Blogs of Bihar Tourism </title>
...
<div class="container">
    ...
    <div class="row">
        ...
        <main class="post blog-post col-lg-8">
            <div class="container">
                <div class="post-single" id="TopFirstBlogOnHeaderDiv">
        ...
        <!---------------------------------------------------  aside-->
        <aside class="col-lg-4" id="TopBlogOnHeaderAsideDiv">
...
<section style="padding:0px 0;">
    <div class="container">
        <header>
            <h1 class="h2">Recent Posts</h1><br>
        </header>
        ...
        <div class="text-center" style="margin-top: 30px;">
            <button id="readBtn" class="btn btn-outline-warning">Load More</button>
        </div>
...
<div class="container">
    ...
    <div class="row">
        <!-- Latest Posts -->
        <main class="post blog-post col-lg-8">
            <div class="container" id="CatblogDiv">
...
<!--<div class="post-id" id="1">-->
<!--    <div class="text-right">-->
<!--        <button id="readBtn" class="btn btn-success">Read More</button>-->
<!--    </div>-->
